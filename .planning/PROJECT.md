...
- ✓ **SPEECH-03**: 识别到的中文语音文字逐句实时插入编辑器光标位置 — Phase 2
- ✓ **SPEECH-06**: 用户可在中文和英文识别之间切换 — Phase 2
- ✓ **SPEECH-07**: 语音识别完全本地运行，无网络请求 — Phase 2
- ✓ **SPEECH-08**: 可配置的静音超时后自动停止识别 — Phase 2
- ✓ **SPEECH-11**: 首次使用引导帮助用户下载模型文件 — Phase 2
